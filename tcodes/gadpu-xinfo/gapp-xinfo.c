...
{ 
    ...
    fprintf(dfp, "\n \"scangroup\": { \"dataFileColToBeUpdated_key\": \"%s\", \"dataFileColToBeUpdated_val\": \"%s\",\"col1_key\": \"%s\", \"col1_val\": \"%s\", \"col2_key\": \"%s\",\"col2_val\": \"%s\", \"corr_version\": \"%s\", \"sta_time\": \"%d\", \"num_pols\": \"%d\", \"num_chans\": \"%d\", \"lta_time\": \"%d\", \"file_path\": \"%s\", \"fileSize_key\":\"%s\", \"fileSize_val\": \"%lf\" }, \"scans\": ["\
        , dataFileColToBeUpdated, ltaltbFileName, col1, file1, col2, file2, corr->version, corr->corrpar.statime, corr->corrpar.pols,
                corr->daspar.channels, corr->daspar.lta, path, fileSizeCol, fileSize);
                ...
                ScanHdr *shdr, char *ltapath, char *obsno, int lscannum,FILE *dfp, int isLTA)
{
    ...
    fprintf(dfp,"\n {\"dataFileColumnInDb_key\":\"%s\", \"dataFileColumnInDb_val\": \"%s\", \"scan_no\": \"%d\", \"source\": \"%s\", \"ra_2000\": %lf, \"dec_2000\": %lf, \"date_obs\": \"%s\", \"ant_mask\": \"%d\", \"band_mask\": \"%d\", \"calcode\": \"%d\", \"qual\": \"%d\", \"ra_date\": \"%f\", \"dec_date\": \"%f\", \"dra\": \"%f\",\"ddec\": \"%f\", \"sky_freq1\": \"%f\", \"sky_freq2\": \"%f\", \"rest_freq1\": \"%f\", \"rest_freq2\": \"%f\", \"lsr_vel1\": \"%f\", \"lsr_vel2\": \"%f\", \"chan_width\": \"%f\", \"net_sign1\": \"%d\", \"net_sign2\": \"%d\", \"net_sign3\": \"%d\", \"net_sign4\": \"%d\", \"onsrc_time\": \"%lf\" ,\"source_position\": \"spoint(%lf,%lf)\"},",dataFileColumnInDb, ltafile, lscannum, scan->source.object, ra, dec, shdr->date_obs, scan->source.antmask, scan->source.bandmask, scan->source.calcode, scan->source.qual,  scan->source.ra_mean, scan->source.dec_mean, scan->source.dra, scan->source.ddec, scan->source.freq[0], scan->source.freq[1], scan->source.rest_freq[0], scan->source.rest_freq[1], scan->source.lsrvel[0], scan->source.lsrvel[1], scan->source.ch_width, scan->source.net_sign[0], scan->source.net_sign[1], scan->source.net_sign[2], scan->source.net_sign[3], time_on_src,ra,dec);
