...
typedef enum { AckMsg, DAS, AcqSrv, CorrSrv, Services } ServiceType;
...
# define ProtBufSize 1024   /* Bytes, restricted by operating system */

enum { InpMsgQ=200, CmdMsgQ=201, MsgPerm=0600 } ;
...
#ifdef _INCLUDE_SERVICE_NAMES_
char *ServiceName[Services] =
{ "AckMsg", "DAS", "AcqSrv", "CorrSrv" };
char *NodeName[Nodes] =
