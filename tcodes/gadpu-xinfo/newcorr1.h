...
enum { MAX_ANTS=32, MAX_SAMPS=64, MAX_FFTS=MAX_SAMPS, MAC_CARDS=33,  
       MAX_BASE=DAS_CARDS*MAX_ANTS*MAC_CARDS, MAX_CHANS=32768, POLS=4  
     };   // %1% MAX_CHANS=256
...
{ int   antmask, samplers, baselines, channels, lta, gsb_maxchan, gsb_fstop;
  ...
  unsigned short chan_num[MAX_CHANS];  /* %3% Maximum Buffer Allocated */
...
# define Corr3Size           29368   /* size of 256 channel, 120 samp CorrType  newcorr ghb*/ 
# define Corr4Size           31152   /* size of 1024 channel, 120 samp CorrType  newcorr gsb CORR REF*/ 
# define Corr5Size           94648   /* size of 32K channel, 120 samp CorrType  newcorr gsb CORR REF*/ 
